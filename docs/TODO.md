...
- [x] **Тестовый набор:** `pytest -q` — **804 passed, 11 warnings** (2026-08-16; warnings: малые synthetic CSCV fixtures и Starlette deprecation; +38 P1.5 demo-execution/reconciliation +29 P1.5.1 partial-submission/volume тестов). Исторические counts в change log не являются текущим статусом.
