...
async function runAllTests() {
  ...
  try {
    ...
    {
      const payloadString = '{"intent_id":"intent_test_999","symbol":"XAUUSD","volume":0.05,"timestamp":1723891200}';
    ...
    // Test 7.5: Byte-exact signed ingress with mismatched signature returns 401
    {
