...
def make_fake_trade(entry_ts=1_700_000_000, exit_ts=1_700_001_000,
                    direction=1, pnl=10.0):
...
def test_save_skips_unclosed_trades(paper_db):
    ...
    open_trade = SimpleNamespace(
        entry_ts=1_700_000_000, exit_ts=None, entry_price=1.0,
        exit_price=None, direction=1, pnl=None, exit_reason=None,
    )
